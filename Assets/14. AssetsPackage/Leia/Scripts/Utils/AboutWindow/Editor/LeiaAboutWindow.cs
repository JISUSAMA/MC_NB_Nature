...
namespace LeiaUnity.EditorUI
{
    ...
    public class LeiaAboutWindow : UnityEditor.EditorWindow
    {
        ...
        const string editor_About_ForcePopUp = "LeiaUnity.About.ForcePopUp";
        ...
        private static bool _isInitialized, forceShow = true;
        ...
        static void GetCurrentVersion()
        {
            ...
            UpdateChecker.CurrentSDKVersion = Diagnostics.SDKStringData.SDKVersionLine;
        ...
        {
            UndoableInputFieldUtils.BoolFieldWithTooltip(() => { forceShow = EditorPrefs.GetBool(editor_About_ForcePopUp, true); return forceShow; }, b => { forceShow = b; EditorPrefs.SetBool(editor_About_ForcePopUp, b); }, "  Automatically Pop-up", "Display this window when opening Unity. Alternatively, this widow can be opened from LeiaUnity -> About", window);
        }
        ...
        [MenuItem("Window/LeiaUnity/About &l")]
        public static void Open()
        {
            ...
            window = GetWindow<LeiaAboutWindow>(true, "About Leia Unity SDK");
            window.minSize = EditorWindowUtils.WindowMinSize;
            _isInitialized = true;
        }

        public static void CheckCurrentSDKVersion()
        {
            UpdateChecker.CurrentSDKVersion = Diagnostics.SDKStringData.SDKVersionLine;
        }

        private void InitilizeWindowTabs()
        {
            ...
            if (versionUpdateWindow == null) {
                versionUpdateWindow = new LeiaVersionUpdateWindow(this);
            }
            else
            {
                versionUpdateWindow._leiaAboutWindow = this;
            }
        }
        ...
        private void Title()
        {
            ...
            EditorWindowUtils.Button(() => { GetWindow<EditorUI.LeiaRecommendedSettings>(true); }, "Leia Recommended Settings"); 
