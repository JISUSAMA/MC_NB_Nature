...
namespace LeiaUnity.EditorUI
{
    ...
    public class LeiaRecommendedSettings : EditorWindow
    {
        ...
        static bool ShouldForceWindowPopUp()
        {
            ...
            int prevIssueCount = EditorPrefs.GetInt(editor_PrevIssueCount, 0);
        ...
        static void InitRecommendations()
        {
            ...
            () =>
            {
                ...
                (PlayerSettings.GetGraphicsAPIs(BuildTarget.StandaloneWindows)[0] != UnityEngine.Rendering.GraphicsDeviceType.Direct3D11 &&
                 PlayerSettings.GetGraphicsAPIs(BuildTarget.StandaloneWindows)[0] != UnityEngine.Rendering.GraphicsDeviceType.Direct3D12));
            },
...
#if !UNITY_2021_1_OR_NEWER && !UNITY_2022_2_OR_NEWER
            recommendations.Add(new Recommendation(
